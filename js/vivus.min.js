...
!function() {
    ...
    e.prototype.setElement = function(t, e) {
        ...
        case window.HTMLObjectElement:
            ...
            r = function(e) {
                if (!n.isReady) {
                    if (n.el = t.contentDocument && t.contentDocument.querySelector("svg"), !n.el && e)
    ...
    e.prototype.drawer = function() {
        ...
        if (this.currentFrame += this.speed, this.currentFrame <= 0)
            ...
            if (!(this.currentFrame >= this.frameLength))
                return this.trace(), this.handle = n(function() {
                    t.drawer()
                }), void 0;
            this.stop(),
